...
fn fixtures() -> Vec<([usize; 4], [usize; 5], &'static str)> {
    vec![
        ...
        (
            hole("As2c3d4h"),
            board("Kc7d6h5s9c"),
            "rainbow board, mixed hole",
        ),
        (
            hole("KsQs2c3c"),
            board("9d8d7c6c5h"),
            "no 3-of-suit on board",
        ),
        (
            hole("AhKhQhJh"),
            board("2c3c4d5s6s"),
            "4 hearts in hole, only 1 on board",
        ),
        ...
        (
            hole("AhKh2c3c"),
            board("4h5h6h7d8d"),
            "3 hearts on board + 2 in hole",
        ),
        (
            hole("AhKh2c3c"),
            board("4h3h5h8h9h"),
            "user-pattern monotone hearts board",
        ),
        (
            hole("AsAhKsKh"),
            board("4s5s6s7s8s"),
            "5 spades board, 2 spades hole",
        ),
        // -- borderline --
        (
            hole("AsKsQsJs"),
            board("Tc9c8c7c6h"),
            "4 clubs on board + 0 in hole (no flush)",
        ),
        (
            hole("AcKc2d3d"),
            board("Qc6c5c4d3h"),
            "exactly 2 clubs hole + 3 clubs board",
        ),
    ]
}

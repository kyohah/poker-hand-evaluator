...
fn matches_production_on_structural_corner_cases() {
    let cases = [
        ...
        ("3-suit board, 2-suit hole", hole("AhKh2c3c"), board("4h5h6h7d8d")),
        ("monotone hearts board", hole("AhKh2c3c"), board("4h3h5h8h9h")),
        ("monotone hearts, no hearts in hole", hole("AsKs2c3c"), board("4h3h5h8h9h")),
        ("4-of-a-kind on board", hole("AsAd2c3c"), board("AhAcKsQsJs")),
        ("paired board, suited hole", hole("AhKhQhJh"), board("AsAdAcKsKc")),
        ("straight playable", hole("5c6d2s3s"), board("7h8s9cKdJh")),
        ("royal flush on board, no hearts in hole", hole("As2c3c4c"), board("AhKhQhJhTh")),
        ("royal flush playable", hole("AhKh2c3c"), board("QhJhTh4d5d")),
        ("user pattern monotone", hole("AsKs2c3c"), board("4h3h5h8h9h")),
        ("widely-separated no-straight board", hole("As4d6c8s"), board("2c3d7h8sQc")),
    ];
